...
function ManageUsers() {
    ...
    const d = [{First_Name:"Aug" ,Last_Name: "Zil", Email: "abc@gmail.com",Type:"user" ,Verified:"yes" ,Subscribed:"no" ,Prompt: "abcd efg hijklmno p qrs tuv wx yz"}]
    // const d = ["Aug","Zil","abc@gmail.com","user","yes","no",[""]]
    return (
        <div className='manageusers_main_container'>01
